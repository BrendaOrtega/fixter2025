...
set -euo pipefail
cd "$(dirname "$0")"
T=26.2; BGM=/tmp/bgm-eve/06.mp3; BGSS=${1:-0}
S=../../shorts-taller/sfx
...
ffmpeg -y -loglevel error -ss "$BGSS" -t 40 -i "$BGM" -af "loudnorm=I=-26:TP=-3:LRA=11,afade=t=in:d=0.3,afade=t=out:st=23.7:d=2.5" -ar 48000 -ac 2 $TMP/bgm.wav
