...
const SPLIT = { Ymuchas: ["Y", "muchas"], Yvuelve: ["Y", "vuelve"], "Yahí": ["Y", "ahí"], "dice¿en": ["dice:", "¿en"] };
// errores de oído
const FIX = { "AMD,": ".md,", "PDF,": "PDF,", "compact,": "compact,", "compact.": "compact." };
...
for (const w of words) {
  ...
  merged.push({ ...w, text: FIX[w.text] ?? w.text });
}
