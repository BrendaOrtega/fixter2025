...
const SPLIT = { Yesto: ["Y", "esto"], Yentonces: ["Y", "entonces"], "personas,¿no?": ["personas,", "¿no?"], "improvisa,¿no?": ["improvisa,", "¿no?"] };
...
const FIX = { entregala: "entrégala", "N8N": "n8n" };
const FIX_AT = { 34.56: "un", 34.90: "agente", 53.24: "el", 53.36: "agente", 60.70: "Un", 61.18: "agente", 61.63: "un", 61.75: "agente" };
...
const fixed = merged.map((w) => ({ ...w, start: w.start + OFFSET, end: w.end + OFFSET }));
