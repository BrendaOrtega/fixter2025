...
const SPLIT = { Xy: ["X", "y"], Xpersona: ["X", "persona"], "Ypersona?": ["Y", "persona?"], Yentonces: ["Y", "entonces"], "tickets¿cómo": ["tickets.", "¿cómo"], "sesión¿no?": ["sesión,", "¿no?"], "API¿no?": ["API,", "¿no?"] };
