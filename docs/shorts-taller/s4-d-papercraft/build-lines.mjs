...
const SPLIT = { Yentonces: ["Y", "entonces"], Ysi: ["Y", "si"], Yse: ["Y", "se"], "Yasígnaselos": ["Y", "asígnaselos"], "Entonces,¿cómo": ["Entonces,", "¿cómo"], "token,¿no?": ["token,", "¿no?"], "permiso,¿sí?": ["permiso,", "¿sí?"], "así,¿cómo": ["así,", "¿cómo"] };
