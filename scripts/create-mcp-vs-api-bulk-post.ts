...
async function main() {
  const post = await db.post.create({
    data: {
      title: "Cuándo NO usar tu MCP (aunque lo tengas a la mano)",
      slug: "cuando-no-usar-tu-mcp",
      body,
      ...
      mainTag: "agentes",
      tags: ["agentes", "claude", "ai", "opinion"],
      metaImage: "https://images.pexels.com/photos/4974915/pexels-photo-4974915.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
      coverImage: "https://images.pexels.com/photos/4974915/pexels-photo-4974915.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
      published: true,
    },
  });
