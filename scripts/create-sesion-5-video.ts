/**
 * Crea el Video de la SESIÓN 5 del taller de sistemas agénticos y lo liga al
 * curso `sistemas-agenticos`, igual que las anteriores.
 *
 * Se corre ANTES de subir el HLS: el `videoId` es parte de las keys de S3.
 *
 *   npx tsx --env-file=.env scripts/create-sesion-5-video.ts
 */
...
const VIDEO_TITLE = "Sesión 5 · Un backend, n canales (WhatsApp)";
const MODULE_NAME = "Diseño de sistemas agénticos";
const DESCRIPTION =
  "Grabación de la sesión 5 del taller (14 de septiembre de 2026): un backend permanente con n canales, por qué Baileys y qué cuesta lo no oficial, vincular WhatsApp a la caja, cada mensaje del grupo como un turno del agente, y el cierre del taller: el recorrido, lo que se llevan y lo que sigue.";
