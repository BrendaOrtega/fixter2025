"""Escena 5: el deploy de la webapp en otra caja de EasyBits.

Quedó pendiente de la sesión 2; se ve en la sesión 3, después de la procedimental.
Uso: python3 scene-sesion-3-hosting.py  → va completa, sin pasos.
"""
import json, sys
...
N = 3  # sin pasos: la pizarra va completa

T(100, 20, "5 · la app en su propia caja", 58, "#6741d9")
