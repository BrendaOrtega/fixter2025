...
export default function BookLayout({
  ...
  return (
    <div className={`max-w-7xl mx-auto relative transition-all duration-300 ${readingMode ? 'max-w-none' : ''}`}>
      <div className="grid grid-cols-[auto_1fr_auto] gap-0 min-h-screen">
        {/* Sidebar - Tabla de contenidos */}
        {sidebar}
        
        {/* Contenido principal */}
        <main className={`min-w-0 py-8 lg:py-16 bg-white transition-all duration-300 ${
          readingMode 
