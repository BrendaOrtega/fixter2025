...
<p style="margin:0 0 20px 0;">
  ...
  <strong>${slot.label}</strong>. Dura una hora y es gratis.
</p>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f6fafa;border-radius:10px;border-left:4px solid #85DDCB;margin-bottom:24px;">
  <tr><td style="padding:16px 18px;">
    ...
    <span style="color:#64748B;font-size:14px;">1 hora · en vivo · hora de la Ciudad de México</span><br/>
...
<ul style="margin:0 0 24px 0;padding-left:20px;color:#475569;font-size:15px;line-height:1.8;">
  <li>Un agente que funciona perfecto… y luego se rompe con un usuario real, en vivo</li>
  <li>Las piezas que le faltan: harness, contexto, checkpoints, aprobación humana</li>
  <li>Sistemas nuestros corriendo hoy en producción, por dentro</li>
