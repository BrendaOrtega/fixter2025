...
<p style="margin:0 0 24px 0;">
  Cuatro pasos, diez minutos. Llega con esto listo y arrancamos escribiendo código.
</p>
...
<h3 style="margin:0 0 12px 0;color:#19262A;font-size:18px;">4. Instala Ghosty Code y arranca</h3>
...
<p style="margin:0 0 28px 0;color:#64748B;font-size:14px;">
  Las dos líneas de en medio le conectan las sandboxes, que son las que usaremos en vivo;
  <code style="font-family:Menlo,Consolas,monospace;">login</code> abre el navegador y autorizas con
  tu cuenta. Pídele algo sencillo y, si responde, ya estás listo. <code style="font-family:Menlo,Consolas,monospace;">--yolo</code>
  lo deja ejecutar sin pedirte permiso en cada paso; el idioma se cambia desde su configuración.
</p>
...
<div style="background:#f6fafa;border-left:3px solid #85DDCB;padding:14px 16px;margin:0 0 24px 0;">
  ...
  <p style="margin:0 0 10px 0;color:#475569;font-size:14px;">
    Sigue usándolo. Lo que construimos no depende de Ghosty Code: conecta EasyBits por MCP con el
    toolset de <strong>sandbox</strong> y tienes las mismas herramientas. En Claude Code:
  </p>
  ${codeBlock('claude mcp add --transport http easybits "https://www.easybits.cloud/api/mcp/sandbox"')}
  <p style="margin:0;color:#64748B;font-size:13px;">
    Otros clientes MCP toman esa misma URL y autorizan igual, desde el navegador.
  </p>
</div>
