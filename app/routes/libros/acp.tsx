...
import type { Route } from "./+types/acp";
...
const chapters = [
  ...
  { id: "01", title: "El primer initialize", slug: "capitulo-01" },
  { id: "02", title: "Sesiones", slug: "capitulo-02" },
  { id: "03", title: "El turno", slug: "capitulo-03" },
  { id: "04", title: "Las manos", slug: "capitulo-04" },
  { id: "05", title: "Permisos", slug: "capitulo-05" },
  { id: "06", title: "Un Agente remoto llamado Ghosty", slug: "capitulo-06" },
  {
    id: "07",
    title: "WebSocket: quién lo trae puesto y quién no",
    slug: "capitulo-07",
  },
  { id: "08", title: "MCP por ACP", slug: "capitulo-08" },
  { id: "09", title: "Revivir", slug: "capitulo-09" },
  { id: "10", title: "Extensibilidad", slug: "capitulo-10" },
  { id: "11", title: "Memoria", slug: "capitulo-11" },
  { id: "12", title: "La interfaz web", slug: "capitulo-12" },
];
...
export const meta = ({ location }: Route.MetaArgs) => {
  ...
  return getMetaTags({
    title: "Agent Client Protocol — Construcción de sistemas agénticos | Fixtergeek",
    description:
              ...
              <div className="hidden lg:flex items-center space-x-3 ml-6 pl-6 border-l border-gray-200">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-xs text-gray-500">
                    Construcción de sistemas agénticos
                  </div>
                </div>
              </div>
            </div>
