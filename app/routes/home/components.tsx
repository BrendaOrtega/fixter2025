  ...
  return (
    ...
    >
      <div className="flex  flex-col-reverse md:flex-row justify-center md:justify-between items-center max-w-7xl mx-auto h-[85vh] gap-0 md:gap-0 lg:gap-20">
        <div>
          {/* Badge de curso disponible */}
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="inline-flex items-center gap-2 bg-gradient-to-r from-brand-700/30 to-brand-500/30 border border-brand-500 rounded-full px-4 py-2 mb-6"
          >
            <span className="animate-pulse h-2 w-2 bg-green-500 rounded-full"></span>
            <span className="text-sm font-bold text-white">
              NUEVO: Curso Claude Code disponible on demand
            </span>
          </motion.div>
